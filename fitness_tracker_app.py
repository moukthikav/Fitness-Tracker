...
st.write("In this WebApp you will be able to observe your predicted calories burned in your body. Pass your parameters such as `Age`, `Gender`, `Weight`, `Height`, etc., into this WebApp and then you will see the predicted value of kilocalories burned.")

st.sidebar.header("User Input Parameters: ")

def user_input_features():
    age = st.sidebar.slider("Age: ", 10, 100, 30)
    weight = st.sidebar.slider("Weight (kg): ", 30, 120, 60)
    height = st.sidebar.slider("Height (cm): ", 120, 200, 170)
...
try:
    calories = pd.read_csv(r"C:\Users\MOUKTHIKA\OneDrive\Desktop\calories.csv")
    exercise = pd.read_csv(r"C:\Users\MOUKTHIKA\OneDrive\Desktop\exercise.csv")
